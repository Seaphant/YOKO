...
- [ ] **Pinout:** Pinout table in `pinout.md` filled [TBD]; matches firmware `config.h` when finalized.
...
- [ ] **Battery + to fuse:** Continuity; fuse rating [TBD] and correct.
- [ ] **Fuse to driver VIN:** Continuity for each driver [TBD].
...
- [ ] **FSR:** FSR signal and reference to ESP32 ADC [TBD]; no short to power.

---

## Polarity and Isolation

- [ ] **Motor polarity:** Per-motor wiring consistent with firmware direction (open/close) [TBD].
