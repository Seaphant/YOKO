...
- **Pass:** Object secured without slip or drop for defined duration (e.g. 3 s; set per test).
...
2. **Pose:** Hand orientation and object position (repeatable fixture or freehand; document in /logs).
